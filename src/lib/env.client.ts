...
if (!process.env.NEXT_PUBLIC_SANITY_STUDIO_BASE_URL)
  throw new Error('NEXT_PUBLIC_SANITY_STUDIO_BASE_URL not defined');
...
export const STUDIO_BASE_URL = process.env.NEXT_PUBLIC_SANITY_STUDIO_BASE_URL;
